...
export default class MButton extends Component {
    ...
    render() {
        ...
        let type = MButton._setDifferentButtonStyle(buttonColor, buttonRadius, buttonType, borderWidth);
    ...
    static _setDifferentButtonStyle(buttonColor, buttonRadius, buttonType, borderWidth) {
        ...
        if (buttonType == "normal") {
            ...
            return MButton._setDifferentStyle(buttonColor, buttonRadius, buttonColor);

        } else if (buttonType == 'stroke') {

            return MButton._setDifferentStyle('transparent', buttonRadius, buttonColor, borderWidth);

        } else if (buttonType == 'text') {

            return MButton._setDifferentStyle('transparent', 0, 'transparent');
        }
    }
