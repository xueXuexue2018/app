...
//获取任务信息
            ...
            .then(result => {
                if (result.code == 1) {
                    ...
                    this.setState({
                        ...
                        isLoading: false,
                        isRefreshing: false,
                        isShow: data.reviewStatus == 1 ? true : false,
                    });
    ...
    render() {
        ...
        //司机
        var driverName = content['driverName'] || "";
        //司机电话
        var driverPhone = content['driverPhone'] || "";
        //开始类型
        ...
        // 5  否
        // 其他 是
        var reviewStatus=content['reviewStatus']||'';
        ...
        ;
        let leftButtonView = <TouchableOpacity onPress={()=>this.props.navigation.pop()}>
                ...
                <View style={styles.container}>
                    ...
                    >
                        <View style={styles.textView}>
                            ...
                            <View style={{backgroundColor: '#F5F5F5', marginLeft: 20, height: 1}}></View>
                            {this.renderSign('是否需要审批',reviewStatus=='5'?'否':'是')}

                            <View style={workName===""?{height: 0}:{backgroundColor: '#F5F5F5', marginLeft: 20, height: 1}}></View>

                            {workName===""?<View></View>:this.renderSign('工作流名称',workName)}
                            ...
                            <View style={{backgroundColor: '#F5F5F5', marginLeft: 20, height: 1}}></View>
                            {this.renderSign('司机',driverName)}
                            <View style={{backgroundColor: '#F5F5F5', marginLeft: 20, height: 1}}></View>
                            {this.renderSign('司机电话',driverPhone)}
