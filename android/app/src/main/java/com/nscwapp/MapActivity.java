...
/**
 * Created by Brucelin on 2018-06-15.
 */
...
//构建Marker图标
                BitmapDescriptor bitmap = BitmapDescriptorFactory
                        .fromResource(R.drawable.bd_maker);
...
//在地图上添加Marker，并显示
        ...
        mBaiduMap.setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                map.putString("latitude",lat+"");
                map.putString("longitude",lon+"");
                ToastExample. promise.resolve(map);
                finish();
                return false;
            }
        });
